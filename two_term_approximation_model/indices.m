function [id_cs,id_cn,id_ap,id_an,id_sp,id_sn,id_jp,id_jn,id_Phip,id_Phin,id_phip,id_phis,id_phin,id_Ta,id_Tp,id_Ts,id_Tn,id_Tz]=indices(Na,Np,Ns,Nn)
    id_cs=Np+2; id_cn=id_cs+Ns+2;
    id_ap=id_cn+Nn+2; id_an=id_ap+Np;
    id_sp=id_an+Nn; id_sn=id_sp+Np;
